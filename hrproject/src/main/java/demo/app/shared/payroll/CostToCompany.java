...
@Entity
@NamedQueries({ @javax.persistence.NamedQuery(name = "CostToCompany.DefaultFinders", query = "select e from CostToCompany e where e.systemInfo.activeStatus=1 and e.empId LIKE :empId"), @javax.persistence.NamedQuery(name = "CostToCompany.findByEmpId", query = "select e from CostToCompany e where e.systemInfo.activeStatus=1 and e.empId=:empId"), @javax.persistence.NamedQuery(name = "CostToCompany.findById", query = "select e from CostToCompany e where e.systemInfo.activeStatus=1 and e.salaryId =:salaryId") })
public class CostToCompany implements Serializable, CommonEntityInterface, Comparator<CostToCompany> {
    ...
    public boolean equals(Object obj) {
        try {
            demo.app.shared.payroll.CostToCompany other = (demo.app.shared.payroll.CostToCompany) obj;
            if (salaryId == null) {
                return false;
