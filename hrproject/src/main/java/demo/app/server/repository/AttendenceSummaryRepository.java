...
public interface AttendenceSummaryRepository<T> extends SearchInterface {
    ...
    public T findById(String attendenceSummaryId) throws Exception, SpartanPersistenceException;
}
