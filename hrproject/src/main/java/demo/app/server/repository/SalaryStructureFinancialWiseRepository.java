...
public interface SalaryStructureFinancialWiseRepository<T> extends SearchInterface {
    ...
    public T findById(String salaryId) throws Exception, SpartanPersistenceException;
}
