...
public interface AttendenceDetailsRepository<T> extends SearchInterface {
    ...
    public T findById(String attendenceId) throws Exception, SpartanPersistenceException;
}
