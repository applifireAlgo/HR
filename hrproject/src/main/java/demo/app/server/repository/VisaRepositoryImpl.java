...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Visa Master table Entity", complexity = Complexity.LOW)
public class VisaRepositoryImpl extends SearchInterfaceImpl implements VisaRepository<Visa> {
    ...
    @Override
    @Transactional
    public List<Visa> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.employee.Visa> query = emanager.createQuery("select u from Visa u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Visa save(Visa entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Visa> save(List<Visa> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.Visa obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.employee.Visa s = emanager.find(demo.app.shared.employee.Visa.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Visa entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Visa> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.Visa obj = entity.get(i);
    ...
    @Transactional
    public Visa findById(String visaCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Visa.findById");
            query.setParameter("visaCode", visaCode);
            demo.app.shared.employee.Visa listOfVisa = (demo.app.shared.employee.Visa) query.getSingleResult();
            return listOfVisa;
        } catch (javax.persistence.PersistenceException e) {
