...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for GradeType Master table Entity", complexity = Complexity.LOW)
public class GradeTypeRepositoryImpl extends SearchInterfaceImpl implements GradeTypeRepository<GradeType> {
    ...
    @Override
    @Transactional
    public List<GradeType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.backgroundcheck.GradeType> query = emanager.createQuery("select u from GradeType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public GradeType save(GradeType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<GradeType> save(List<GradeType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.GradeType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.backgroundcheck.GradeType s = emanager.find(demo.app.shared.backgroundcheck.GradeType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(GradeType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<GradeType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.GradeType obj = entity.get(i);
    ...
    @Transactional
    public GradeType findById(String grdCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("GradeType.findById");
            query.setParameter("grdCode", grdCode);
            demo.app.shared.backgroundcheck.GradeType listOfGradeType = (demo.app.shared.backgroundcheck.GradeType) query.getSingleResult();
            return listOfGradeType;
        } catch (javax.persistence.PersistenceException e) {
