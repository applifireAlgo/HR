...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<demo.app.shared.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.authorization.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.authorization.AppMenus s = emanager.find(demo.app.shared.authorization.AppMenus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppMenus findById(String menuId) throws Exception, SpartanPersistenceException {
        try {
            ...
            demo.app.shared.authorization.AppMenus listOfAppMenus = (demo.app.shared.authorization.AppMenus) query.getSingleResult();
