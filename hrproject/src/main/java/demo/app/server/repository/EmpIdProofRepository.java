...
public interface EmpIdProofRepository<T> extends SearchInterface {
    ...
    public List<T> findByIdCode(String idCode) throws Exception, SpartanPersistenceException;

    public T findById(String empIdpk) throws Exception, SpartanPersistenceException;
}
