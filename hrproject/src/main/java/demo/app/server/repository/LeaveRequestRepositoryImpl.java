...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for LeaveRequest Master table Entity", complexity = Complexity.LOW)
public class LeaveRequestRepositoryImpl extends SearchInterfaceImpl implements LeaveRequestRepository<LeaveRequest> {
    ...
    @Override
    @Transactional
    public List<LeaveRequest> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.attendance.LeaveRequest> query = emanager.createQuery("select u from LeaveRequest u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public LeaveRequest save(LeaveRequest entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<LeaveRequest> save(List<LeaveRequest> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.LeaveRequest obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.attendance.LeaveRequest s = emanager.find(demo.app.shared.attendance.LeaveRequest.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(LeaveRequest entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<LeaveRequest> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.LeaveRequest obj = entity.get(i);
    ...
    @Transactional
    public List<LeaveRequest> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("LeaveRequest.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.attendance.LeaveRequest> listOfLeaveRequest = query.getResultList();
    ...
    @Transactional
    public LeaveRequest findById(String leaveRequestId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("LeaveRequest.findById");
            query.setParameter("leaveRequestId", leaveRequestId);
            demo.app.shared.attendance.LeaveRequest listOfLeaveRequest = (demo.app.shared.attendance.LeaveRequest) query.getSingleResult();
            return listOfLeaveRequest;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
