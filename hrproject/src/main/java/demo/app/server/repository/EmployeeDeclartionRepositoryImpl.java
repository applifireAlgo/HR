...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for EmployeeDeclartion Master table Entity", complexity = Complexity.LOW)
public class EmployeeDeclartionRepositoryImpl extends SearchInterfaceImpl implements EmployeeDeclartionRepository<EmployeeDeclartion> {
    ...
    @Override
    @Transactional
    public List<EmployeeDeclartion> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.payroll.EmployeeDeclartion> query = emanager.createQuery("select u from EmployeeDeclartion u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmployeeDeclartion save(EmployeeDeclartion entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmployeeDeclartion> save(List<EmployeeDeclartion> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.EmployeeDeclartion obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.payroll.EmployeeDeclartion s = emanager.find(demo.app.shared.payroll.EmployeeDeclartion.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmployeeDeclartion entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmployeeDeclartion> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.EmployeeDeclartion obj = entity.get(i);
    ...
    @Transactional
    public List<EmployeeDeclartion> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmployeeDeclartion.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.payroll.EmployeeDeclartion> listOfEmployeeDeclartion = query.getResultList();
            return listOfEmployeeDeclartion;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public EmployeeDeclartion findById(String empDecId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmployeeDeclartion.findById");
            query.setParameter("empDecId", empDecId);
            demo.app.shared.payroll.EmployeeDeclartion listOfEmployeeDeclartion = (demo.app.shared.payroll.EmployeeDeclartion) query.getSingleResult();
            return listOfEmployeeDeclartion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
