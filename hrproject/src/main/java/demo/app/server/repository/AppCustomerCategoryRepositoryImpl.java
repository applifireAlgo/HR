...
public class AppCustomerCategoryRepositoryImpl extends SearchInterfaceImpl implements AppCustomerCategoryRepository<AppCustomerCategory> {
    ...
    public List<AppCustomerCategory> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<demo.app.shared.customers.AppCustomerCategory> query = emanager.createQuery("select u from AppCustomerCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomerCategory> save(List<AppCustomerCategory> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.customers.AppCustomerCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.customers.AppCustomerCategory s = emanager.find(demo.app.shared.customers.AppCustomerCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppCustomerCategory findById(String appcustCategoryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            demo.app.shared.customers.AppCustomerCategory listOfAppCustomerCategory = (demo.app.shared.customers.AppCustomerCategory) query.getSingleResult();
