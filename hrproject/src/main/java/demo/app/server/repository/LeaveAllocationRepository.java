...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for LeaveAllocation Master table Entity", complexity = Complexity.LOW)
public interface LeaveAllocationRepository<T> extends SearchInterface {
    ...
    public T findById(String leaveCategoryId) throws Exception, SpartanPersistenceException;
}
