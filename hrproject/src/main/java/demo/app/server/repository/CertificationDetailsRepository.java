...
public interface CertificationDetailsRepository<T> extends SearchInterface {
    ...
    public List<T> findByCertCode(String certCode) throws Exception, SpartanPersistenceException;

    public List<T> findByGrdCode(String grdCode) throws Exception, SpartanPersistenceException;

    public T findById(String certPk) throws Exception, SpartanPersistenceException;
}
