...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for PaySlip Transaction table", complexity = Complexity.MEDIUM)
public class PaySlipRepositoryImpl extends SearchInterfaceImpl implements PaySlipRepository<PaySlip> {
    ...
    @Override
    @Transactional
    public List<PaySlip> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.payroll.PaySlip> query = emanager.createQuery("select u from PaySlip u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public PaySlip save(PaySlip entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<PaySlip> save(List<PaySlip> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.PaySlip obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.payroll.PaySlip s = emanager.find(demo.app.shared.payroll.PaySlip.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(PaySlip entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<PaySlip> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.PaySlip obj = entity.get(i);
    ...
    @Transactional
    public List<PaySlip> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("PaySlip.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.payroll.PaySlip> listOfPaySlip = query.getResultList();
    ...
    @Transactional
    public PaySlip findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("PaySlip.findById");
            query.setParameter("salaryId", salaryId);
            demo.app.shared.payroll.PaySlip listOfPaySlip = (demo.app.shared.payroll.PaySlip) query.getSingleResult();
            return listOfPaySlip;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
