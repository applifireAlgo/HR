...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for EmployeeLeaveSummary Transaction table", complexity = Complexity.MEDIUM)
public class EmployeeLeaveSummaryRepositoryImpl extends SearchInterfaceImpl implements EmployeeLeaveSummaryRepository<EmployeeLeaveSummary> {
    ...
    @Override
    @Transactional
    public List<EmployeeLeaveSummary> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.attendance.EmployeeLeaveSummary> query = emanager.createQuery("select u from EmployeeLeaveSummary u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmployeeLeaveSummary save(EmployeeLeaveSummary entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmployeeLeaveSummary> save(List<EmployeeLeaveSummary> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.EmployeeLeaveSummary obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.attendance.EmployeeLeaveSummary s = emanager.find(demo.app.shared.attendance.EmployeeLeaveSummary.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmployeeLeaveSummary entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmployeeLeaveSummary> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.EmployeeLeaveSummary obj = entity.get(i);
    ...
    @Transactional
    public List<EmployeeLeaveSummary> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmployeeLeaveSummary.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.attendance.EmployeeLeaveSummary> listOfEmployeeLeaveSummary = query.getResultList();
            return listOfEmployeeLeaveSummary;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public EmployeeLeaveSummary findById(String empLeaveStatusId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmployeeLeaveSummary.findById");
            query.setParameter("empLeaveStatusId", empLeaveStatusId);
            demo.app.shared.attendance.EmployeeLeaveSummary listOfEmployeeLeaveSummary = (demo.app.shared.attendance.EmployeeLeaveSummary) query.getSingleResult();
            return listOfEmployeeLeaveSummary;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
