...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for DocumentList Transaction table", complexity = Complexity.MEDIUM)
public class DocumentListRepositoryImpl extends SearchInterfaceImpl implements DocumentListRepository<DocumentList> {
    ...
    @Override
    @Transactional
    public List<DocumentList> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.documentmanager.DocumentList> query = emanager.createQuery("select u from DocumentList u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DocumentList save(DocumentList entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DocumentList> save(List<DocumentList> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.documentmanager.DocumentList obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.documentmanager.DocumentList s = emanager.find(demo.app.shared.documentmanager.DocumentList.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DocumentList entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DocumentList> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.documentmanager.DocumentList obj = entity.get(i);
    ...
    @Transactional
    public List<DocumentList> findByDocTypeCode(String docTypeCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("DocumentList.findByDocTypeCode");
            query.setParameter("docTypeCode", docTypeCode);
            java.util.List<demo.app.shared.documentmanager.DocumentList> listOfDocumentList = query.getResultList();
            return listOfDocumentList;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public DocumentList findById(String docId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("DocumentList.findById");
            query.setParameter("docId", docId);
            demo.app.shared.documentmanager.DocumentList listOfDocumentList = (demo.app.shared.documentmanager.DocumentList) query.getSingleResult();
            return listOfDocumentList;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
