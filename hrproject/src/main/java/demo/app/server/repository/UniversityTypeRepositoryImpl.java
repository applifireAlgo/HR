...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for UniversityType Master table Entity", complexity = Complexity.LOW)
public class UniversityTypeRepositoryImpl extends SearchInterfaceImpl implements UniversityTypeRepository<UniversityType> {
    ...
    @Override
    @Transactional
    public List<UniversityType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.backgroundcheck.UniversityType> query = emanager.createQuery("select u from UniversityType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public UniversityType save(UniversityType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<UniversityType> save(List<UniversityType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.UniversityType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.backgroundcheck.UniversityType s = emanager.find(demo.app.shared.backgroundcheck.UniversityType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(UniversityType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<UniversityType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.UniversityType obj = entity.get(i);
    ...
    @Transactional
    public UniversityType findById(String unvCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("UniversityType.findById");
            query.setParameter("unvCode", unvCode);
            demo.app.shared.backgroundcheck.UniversityType listOfUniversityType = (demo.app.shared.backgroundcheck.UniversityType) query.getSingleResult();
            return listOfUniversityType;
        } catch (javax.persistence.PersistenceException e) {
