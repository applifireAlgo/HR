...
public class EducationDetailsRepositoryImpl extends SearchInterfaceImpl implements EducationDetailsRepository<EducationDetails> {
    ...
    @Override
    @Transactional
    public List<EducationDetails> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.backgroundcheck.EducationDetails> query = emanager.createQuery("select u from EducationDetails u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EducationDetails save(EducationDetails entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EducationDetails> save(List<EducationDetails> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.EducationDetails obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.backgroundcheck.EducationDetails s = emanager.find(demo.app.shared.backgroundcheck.EducationDetails.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<EducationDetails> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EducationDetails.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.backgroundcheck.EducationDetails> listOfEducationDetails = query.getResultList();
    ...
    @Transactional
    public List<EducationDetails> findByDegreeCode(String degreeCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EducationDetails.findByDegreeCode");
            query.setParameter("degreeCode", degreeCode);
            java.util.List<demo.app.shared.backgroundcheck.EducationDetails> listOfEducationDetails = query.getResultList();
            return listOfEducationDetails;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
    ...
    @Transactional
    public List<EducationDetails> findByUnvCode(String unvCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EducationDetails.findByUnvCode");
            query.setParameter("unvCode", unvCode);
            java.util.List<demo.app.shared.backgroundcheck.EducationDetails> listOfEducationDetails = query.getResultList();
            return listOfEducationDetails;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
    ...
    @Transactional
    public EducationDetails findById(String eduPk) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EducationDetails.findById");
            query.setParameter("eduPk", eduPk);
            demo.app.shared.backgroundcheck.EducationDetails listOfEducationDetails = (demo.app.shared.backgroundcheck.EducationDetails) query.getSingleResult();
            return listOfEducationDetails;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
