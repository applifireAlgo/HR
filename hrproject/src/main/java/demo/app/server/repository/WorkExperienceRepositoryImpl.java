...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for WorkExperience Transaction table", complexity = Complexity.MEDIUM)
public class WorkExperienceRepositoryImpl extends SearchInterfaceImpl implements WorkExperienceRepository<WorkExperience> {
    ...
    @Override
    @Transactional
    public List<WorkExperience> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.backgroundcheck.WorkExperience> query = emanager.createQuery("select u from WorkExperience u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public WorkExperience save(WorkExperience entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<WorkExperience> save(List<WorkExperience> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.WorkExperience obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.backgroundcheck.WorkExperience s = emanager.find(demo.app.shared.backgroundcheck.WorkExperience.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<WorkExperience> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("WorkExperience.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.backgroundcheck.WorkExperience> listOfWorkExperience = query.getResultList();
    ...
    @Transactional
    public WorkExperience findById(String workPk) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("WorkExperience.findById");
            query.setParameter("workPk", workPk);
            demo.app.shared.backgroundcheck.WorkExperience listOfWorkExperience = (demo.app.shared.backgroundcheck.WorkExperience) query.getSingleResult();
            return listOfWorkExperience;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
