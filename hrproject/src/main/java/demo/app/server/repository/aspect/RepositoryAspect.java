package demo.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* demo.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demo.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demo.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demo.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demo.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* demo.app.server.repository..*(..))")
