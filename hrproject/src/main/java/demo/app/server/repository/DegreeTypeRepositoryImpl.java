...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for DegreeType Master table Entity", complexity = Complexity.LOW)
public class DegreeTypeRepositoryImpl extends SearchInterfaceImpl implements DegreeTypeRepository<DegreeType> {
    ...
    @Override
    @Transactional
    public List<DegreeType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.backgroundcheck.DegreeType> query = emanager.createQuery("select u from DegreeType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DegreeType save(DegreeType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DegreeType> save(List<DegreeType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.DegreeType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.backgroundcheck.DegreeType s = emanager.find(demo.app.shared.backgroundcheck.DegreeType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DegreeType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DegreeType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.backgroundcheck.DegreeType obj = entity.get(i);
    ...
    @Transactional
    public DegreeType findById(String degreeCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("DegreeType.findById");
            query.setParameter("degreeCode", degreeCode);
            demo.app.shared.backgroundcheck.DegreeType listOfDegreeType = (demo.app.shared.backgroundcheck.DegreeType) query.getSingleResult();
            return listOfDegreeType;
        } catch (javax.persistence.PersistenceException e) {
