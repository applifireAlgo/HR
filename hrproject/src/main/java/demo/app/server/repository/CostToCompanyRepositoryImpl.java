...
public class CostToCompanyRepositoryImpl extends SearchInterfaceImpl implements CostToCompanyRepository<CostToCompany> {
    ...
    @Override
    @Transactional
    public List<CostToCompany> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.payroll.CostToCompany> query = emanager.createQuery("select u from CostToCompany u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CostToCompany save(CostToCompany entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CostToCompany> save(List<CostToCompany> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.CostToCompany obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.payroll.CostToCompany s = emanager.find(demo.app.shared.payroll.CostToCompany.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CostToCompany entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CostToCompany> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.CostToCompany obj = entity.get(i);
    ...
    @Transactional
    public List<CostToCompany> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CostToCompany.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.payroll.CostToCompany> listOfCostToCompany = query.getResultList();
    ...
    @Transactional
    public CostToCompany findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CostToCompany.findById");
            query.setParameter("salaryId", salaryId);
            demo.app.shared.payroll.CostToCompany listOfCostToCompany = (demo.app.shared.payroll.CostToCompany) query.getSingleResult();
            return listOfCostToCompany;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
