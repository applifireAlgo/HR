...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for AttendenceSummary Transaction table", complexity = Complexity.MEDIUM)
public class AttendenceSummaryRepositoryImpl extends SearchInterfaceImpl implements AttendenceSummaryRepository<AttendenceSummary> {
    ...
    @Override
    @Transactional
    public List<AttendenceSummary> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.attendance.AttendenceSummary> query = emanager.createQuery("select u from AttendenceSummary u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public AttendenceSummary save(AttendenceSummary entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<AttendenceSummary> save(List<AttendenceSummary> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.AttendenceSummary obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.attendance.AttendenceSummary s = emanager.find(demo.app.shared.attendance.AttendenceSummary.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(AttendenceSummary entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<AttendenceSummary> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.AttendenceSummary obj = entity.get(i);
    ...
    @Transactional
    public List<AttendenceSummary> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AttendenceSummary.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.attendance.AttendenceSummary> listOfAttendenceSummary = query.getResultList();
            return listOfAttendenceSummary;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public AttendenceSummary findById(String attendenceSummaryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AttendenceSummary.findById");
            query.setParameter("attendenceSummaryId", attendenceSummaryId);
            demo.app.shared.attendance.AttendenceSummary listOfAttendenceSummary = (demo.app.shared.attendance.AttendenceSummary) query.getSingleResult();
            return listOfAttendenceSummary;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
