...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for IdProofInformation Master table Entity", complexity = Complexity.LOW)
public class IdProofInformationRepositoryImpl extends SearchInterfaceImpl implements IdProofInformationRepository<IdProofInformation> {
    ...
    @Override
    @Transactional
    public List<IdProofInformation> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.employee.IdProofInformation> query = emanager.createQuery("select u from IdProofInformation u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IdProofInformation save(IdProofInformation entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IdProofInformation> save(List<IdProofInformation> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.IdProofInformation obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.employee.IdProofInformation s = emanager.find(demo.app.shared.employee.IdProofInformation.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IdProofInformation entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IdProofInformation> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.IdProofInformation obj = entity.get(i);
    ...
    @Transactional
    public IdProofInformation findById(String idCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IdProofInformation.findById");
            query.setParameter("idCode", idCode);
            demo.app.shared.employee.IdProofInformation listOfIdProofInformation = (demo.app.shared.employee.IdProofInformation) query.getSingleResult();
            return listOfIdProofInformation;
        } catch (javax.persistence.PersistenceException e) {
