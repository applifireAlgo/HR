...
public interface EmployeeLeaveSummaryRepository<T> extends SearchInterface {
    ...
    public T findById(String empLeaveStatusId) throws Exception, SpartanPersistenceException;
}
