...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for SalaryStructureFinancialWise Master table Entity", complexity = Complexity.LOW)
public class SalaryStructureFinancialWiseRepositoryImpl extends SearchInterfaceImpl implements SalaryStructureFinancialWiseRepository<SalaryStructureFinancialWise> {
    ...
    @Override
    @Transactional
    public List<SalaryStructureFinancialWise> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.payroll.SalaryStructureFinancialWise> query = emanager.createQuery("select u from SalaryStructureFinancialWise u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public SalaryStructureFinancialWise save(SalaryStructureFinancialWise entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<SalaryStructureFinancialWise> save(List<SalaryStructureFinancialWise> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.SalaryStructureFinancialWise obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.payroll.SalaryStructureFinancialWise s = emanager.find(demo.app.shared.payroll.SalaryStructureFinancialWise.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(SalaryStructureFinancialWise entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<SalaryStructureFinancialWise> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.payroll.SalaryStructureFinancialWise obj = entity.get(i);
    ...
    @Transactional
    public List<SalaryStructureFinancialWise> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SalaryStructureFinancialWise.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.payroll.SalaryStructureFinancialWise> listOfSalaryStructureFinancialWise = query.getResultList();
            return listOfSalaryStructureFinancialWise;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public SalaryStructureFinancialWise findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SalaryStructureFinancialWise.findById");
            query.setParameter("salaryId", salaryId);
            demo.app.shared.payroll.SalaryStructureFinancialWise listOfSalaryStructureFinancialWise = (demo.app.shared.payroll.SalaryStructureFinancialWise) query.getSingleResult();
            return listOfSalaryStructureFinancialWise;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
