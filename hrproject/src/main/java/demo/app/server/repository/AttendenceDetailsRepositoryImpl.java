...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for AttendenceDetails Transaction table", complexity = Complexity.MEDIUM)
public class AttendenceDetailsRepositoryImpl extends SearchInterfaceImpl implements AttendenceDetailsRepository<AttendenceDetails> {
    ...
    @Override
    @Transactional
    public List<AttendenceDetails> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.attendance.AttendenceDetails> query = emanager.createQuery("select u from AttendenceDetails u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public AttendenceDetails save(AttendenceDetails entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<AttendenceDetails> save(List<AttendenceDetails> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.AttendenceDetails obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.attendance.AttendenceDetails s = emanager.find(demo.app.shared.attendance.AttendenceDetails.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(AttendenceDetails entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<AttendenceDetails> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.attendance.AttendenceDetails obj = entity.get(i);
    ...
    @Transactional
    public List<AttendenceDetails> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AttendenceDetails.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.attendance.AttendenceDetails> listOfAttendenceDetails = query.getResultList();
            return listOfAttendenceDetails;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public AttendenceDetails findById(String attendenceId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AttendenceDetails.findById");
            query.setParameter("attendenceId", attendenceId);
            demo.app.shared.attendance.AttendenceDetails listOfAttendenceDetails = (demo.app.shared.attendance.AttendenceDetails) query.getSingleResult();
            return listOfAttendenceDetails;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
