...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CostToCompany Master table Entity", complexity = Complexity.LOW)
