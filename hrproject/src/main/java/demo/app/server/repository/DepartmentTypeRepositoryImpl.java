...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for DepartmentType Master table Entity", complexity = Complexity.LOW)
public class DepartmentTypeRepositoryImpl extends SearchInterfaceImpl implements DepartmentTypeRepository<DepartmentType> {
    ...
    @Override
    @Transactional
    public List<DepartmentType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.employee.DepartmentType> query = emanager.createQuery("select u from DepartmentType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DepartmentType save(DepartmentType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DepartmentType> save(List<DepartmentType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.DepartmentType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.employee.DepartmentType s = emanager.find(demo.app.shared.employee.DepartmentType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DepartmentType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DepartmentType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.DepartmentType obj = entity.get(i);
    ...
    @Transactional
    public DepartmentType findById(String deptTypeCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            ...
            demo.app.shared.employee.DepartmentType listOfDepartmentType = (demo.app.shared.employee.DepartmentType) query.getSingleResult();
