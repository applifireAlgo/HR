...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for EmpIdProof Master table Entity", complexity = Complexity.LOW)
public class EmpIdProofRepositoryImpl extends SearchInterfaceImpl implements EmpIdProofRepository<EmpIdProof> {
    ...
    @Override
    @Transactional
    public List<EmpIdProof> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<demo.app.shared.employee.EmpIdProof> query = emanager.createQuery("select u from EmpIdProof u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmpIdProof save(EmpIdProof entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmpIdProof> save(List<EmpIdProof> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.EmpIdProof obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.employee.EmpIdProof s = emanager.find(demo.app.shared.employee.EmpIdProof.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmpIdProof entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmpIdProof> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.employee.EmpIdProof obj = entity.get(i);
    ...
    @Transactional
    public List<EmpIdProof> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmpIdProof.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<demo.app.shared.employee.EmpIdProof> listOfEmpIdProof = query.getResultList();
            return listOfEmpIdProof;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<EmpIdProof> findByIdCode(String idCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmpIdProof.findByIdCode");
    ...
    @Transactional
    public EmpIdProof findById(String empIdpk) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("EmpIdProof.findById");
            query.setParameter("empIdpk", empIdpk);
            demo.app.shared.employee.EmpIdProof listOfEmpIdProof = (demo.app.shared.employee.EmpIdProof) query.getSingleResult();
            return listOfEmpIdProof;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
