...
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<demo.app.shared.location.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Language> save(List<Language> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                demo.app.shared.location.Language obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            demo.app.shared.location.Language s = emanager.find(demo.app.shared.location.Language.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Language findById(String languageId) throws Exception, SpartanPersistenceException {
        try {
            ...
            demo.app.shared.location.Language listOfLanguage = (demo.app.shared.location.Language) query.getSingleResult();
