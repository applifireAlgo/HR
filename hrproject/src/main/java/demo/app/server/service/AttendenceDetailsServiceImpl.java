...
@RequestMapping("/AttendenceDetails")
public class AttendenceDetailsServiceImpl extends AttendenceDetailsService {
    ...
    @Autowired
    private AttendenceDetailsRepository<AttendenceDetails> attendenceDetailsrepo;
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<demo.app.shared.attendance.AttendenceDetails> lstattendencedetails = attendenceDetailsrepo.findAll();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstattendencedetails);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    }

    @RequestMapping(consumes = "application/json", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody AttendenceDetails entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            attendenceDetailsrepo.save(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<AttendenceDetails> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            attendenceDetailsrepo.save(entity);
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            attendenceDetailsrepo.delete(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody AttendenceDetails entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            attendenceDetailsrepo.update(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<AttendenceDetails> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            attendenceDetailsrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> search(@RequestBody Map<String, Object> fieldData) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<java.lang.Object> lstattendencedetails = attendenceDetailsrepo.search("AttendenceDetails.DefaultFinders", fieldData, getFieldMetaData());
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstattendencedetails);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("inTime", "timestamp");
        fieldMetaData.put("outTime", "timestamp");
    ...
    public HttpEntity<ResponseBean> findByEmpId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<demo.app.shared.attendance.AttendenceDetails> lstattendencedetails = attendenceDetailsrepo.findByEmpId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstattendencedetails);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            demo.app.shared.attendance.AttendenceDetails lstattendencedetails = attendenceDetailsrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstattendencedetails);
        } catch (org.springframework.transaction.TransactionException e) {
