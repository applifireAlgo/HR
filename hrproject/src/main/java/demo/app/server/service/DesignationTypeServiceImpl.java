...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Service for DesignationType Master table Entity", complexity = Complexity.LOW)
...
public class DesignationTypeServiceImpl extends DesignationTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<demo.app.shared.employee.DesignationType> lstdesignationtype = designationTyperepo.findAll();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody DesignationType entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<DesignationType> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            designationTyperepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody DesignationType entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<DesignationType> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            designationTyperepo.update(entity);
    ...
    public HttpEntity<ResponseBean> search(@RequestBody Map<String, Object> fieldData) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<java.lang.Object> lstdesignationtype = designationTyperepo.search("DesignationType.DefaultFinders", fieldData, getFieldMetaData());
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstdesignationtype);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("designatnTypeDesc", "String");
        fieldMetaData.put("designatnTypeHelp", "String");
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            demo.app.shared.employee.DesignationType lstdesignationtype = designationTyperepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdesignationtype);
        } catch (org.springframework.transaction.TransactionException e) {
