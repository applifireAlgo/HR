Ext.define('Hrproject.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Hrproject.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Hrproject.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Hrproject.view.querybuildernewmodel.floatingentity.EntitySprite',
