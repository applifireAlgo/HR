Ext.define('Hrproject.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Hrproject.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Hrproject.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Hrproject.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Hrproject.view.querybuildernewmodel.querydetail.QueryDetail');
