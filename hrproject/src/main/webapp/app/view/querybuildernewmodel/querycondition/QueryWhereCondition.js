Ext.define('Hrproject.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Hrproject.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
