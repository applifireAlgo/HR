Ext.define('Hrproject.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Hrproject.view.querybuildernewmodel.querycondition.QuerySelectController',
