Ext.define('Hrproject.view.querybuildernewmodel.querycondition.QueryWhereConditionController', {
	...
	beforeCellEdit : function(editor, context, eOpts){
		...
		if(context.record.isRoot()||(context.record.isFirst()&&context.colIdx ==1 && 
			...
			var whereClauseWindow = Ext.create('Hrproject.view.querybuildernewmodel.querycondition.QueryWhereClauseWindow',{
