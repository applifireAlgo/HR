Ext.define('Hrproject.view.querybuildernewmodel.queryentities.QueryEntitiesController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-entities-tree',
	requires:['Hrproject.view.querybuildernewmodel.floatingentity.FloatingEntity','Ext.tree.*'],
	entTreePanel:null,
	queryBuilder :null,
	draggedRecord:null,
	init:function(){
