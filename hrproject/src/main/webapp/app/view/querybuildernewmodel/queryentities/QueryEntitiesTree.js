Ext.define('Hrproject.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Hrproject.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
