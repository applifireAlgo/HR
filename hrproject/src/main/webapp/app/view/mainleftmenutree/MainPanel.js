Ext.define('Hrproject.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Hrproject.view.resource.ResourcePanel',
			'Hrproject.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Hrproject.view.resource.DockedResourcePanel','Hrproject.view.fw.mainViewPanel.MainPanelController' ],
