Ext.define('Hrproject.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Hrproject.view.reportui.datachart.chart.RatingField','Hrproject.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
