Ext.define('Hrproject.view.mobileview.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Hrproject.view.mobileview.scheduler.scheduler"
		var component = Ext.create(
				"Hrproject.view.mobileview.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Hrproject.view.mobileview.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
