 ...
 * 
 */
Ext.define('Hrproject.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Hrproject.view.securityconfig.SecurityConfigController',
			'Hrproject.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
