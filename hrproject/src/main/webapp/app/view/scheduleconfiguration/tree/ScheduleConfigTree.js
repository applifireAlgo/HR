 ...
 * 
 */
Ext.define("Hrproject.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Hrproject.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
