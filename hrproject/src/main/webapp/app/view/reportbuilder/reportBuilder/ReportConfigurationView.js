Ext.define('Hrproject.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Hrproject.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Hrproject.view.reportbuilder.gridconfig.GridConfigView',
	           'Hrproject.view.reportbuilder.properties.PropertiesPanelView',
	           'Hrproject.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
