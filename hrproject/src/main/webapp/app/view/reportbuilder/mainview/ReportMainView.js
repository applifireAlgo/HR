Ext.define('Hrproject.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Hrproject.view.reportbuilder.reportlist.ReportListPanelView',
             'Hrproject.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Hrproject.view.reportbuilder.mainview.ReportMainController'
             ],
