Ext.define('Hrproject.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Hrproject.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Hrproject.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Hrproject.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Hrproject.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
