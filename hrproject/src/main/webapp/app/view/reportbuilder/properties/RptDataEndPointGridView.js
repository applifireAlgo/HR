Ext.define('Hrproject.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Hrproject.view.reportbuilder.properties.RptDataEndPointGridController'],
