...
Ext
		.define(
				'Hrproject.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Hrproject.view.logger.tabs.details.DetailsTab',
							'Hrproject.view.logger.tabs.fileconnector.FileConnectorTab',
							'Hrproject.view.logger.tabs.dbconnector.DBConnectorTab',
							'Hrproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Hrproject.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Hrproject.view.logger.LogConfigurationTabPanelController',
