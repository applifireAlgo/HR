 ...
 * 
 */
Ext.define('Hrproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Hrproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
