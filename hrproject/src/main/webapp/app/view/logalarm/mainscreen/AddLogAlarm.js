 ...
 * 
 */
Ext.define('Hrproject.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Hrproject.view.logalarm.mainscreen.AddLogAlarmController',
			'Hrproject.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Hrproject.view.logalarm.mainscreen.AppAlarmPanel',
