 ...
 * 
 */
Ext.define('Hrproject.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Hrproject.view.logalarm.LogAlarmMainViewController',
			'Hrproject.view.logalarm.tree.LogAlarmTreePanel',
			'Hrproject.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
