Ext.define('Hrproject.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Hrproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Hrproject.model.AddUserDataModel' ],
