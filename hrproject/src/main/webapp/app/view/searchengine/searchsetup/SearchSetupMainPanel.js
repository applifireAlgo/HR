 ...
 * 
 */
Ext.define('Hrproject.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Hrproject.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Hrproject.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
