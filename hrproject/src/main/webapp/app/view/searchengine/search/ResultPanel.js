Ext
		.define(
				'Hrproject.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Hrproject.view.searchengine.search.SearchEngineMainPanelController','Hrproject.view.searchengine.search.PanelHeaderField' ,'Hrproject.view.searchengine.search.ReportGridView','Hrproject.view.searchengine.search.ReportChartView','Hrproject.view.searchengine.search.documentView','Hrproject.view.searchengine.search.DouMeanView','Hrproject.view.googlemaps.map.MapPanel'],
