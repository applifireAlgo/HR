Ext.define('Hrproject.hrproject.web.demo.controller.payroll.PaySlipMainController', {
     extend: 'Hrproject.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.PaySlipMainController',
     init: function() {
     ...
     refreshMainForm: function(but, data) {
          ...
          if (data != null) {
               var grid = this.view.down('#PaySlipGrid');
               grid.store.add(data);
          }
     },
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var formPanel = this.getView().down('#PaySlip');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#PaySlip').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#PaySlipGrid').store;
          gridStore.removeAll();
