Ext.define('Hrproject.hrproject.web.demo.controller.employee.DepartmentTypeMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#DepartmentType');
          var grid = this.view.down('#DepartmentTypeGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#DepartmentType");
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DepartmentType').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.deptTypeCode;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#DepartmentType').getViewModel().setData(responseData.response.data);
     },
