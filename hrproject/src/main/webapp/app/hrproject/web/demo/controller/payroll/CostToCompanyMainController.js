Ext.define('Hrproject.hrproject.web.demo.controller.payroll.CostToCompanyMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var formPanel = this.getView().down('#CostToCompany');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CostToCompany').down('#' + me.column.dataIndex + '').store;
     ...
     saveForm: function(but, evt) {
          ...
          var me = this;
          Ext.Ajax.request({
               url: 'secure/CTCCalculationServicetopWS/process/',
               but: but,
               method: method,
               maskEnable: true,
               maskEle: form,
