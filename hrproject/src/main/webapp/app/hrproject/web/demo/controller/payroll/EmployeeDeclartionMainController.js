Ext.define('Hrproject.hrproject.web.demo.controller.payroll.EmployeeDeclartionMainController', {
     extend: 'Hrproject.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.EmployeeDeclartionMainController',
     init: function() {
     ...
     refreshMainForm: function(but, data) {
          ...
          if (data != null) {
               var grid = this.view.down('#EmployeeDeclartionGrid');
               grid.store.add(data);
          }
     },
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.empDecId;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var formPanel = this.getView().down('#EmployeeDeclartion');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#EmployeeDeclartion').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#EmployeeDeclartionGrid').store;
          gridStore.removeAll();
