Ext.define('Hrproject.hrproject.web.demo.controller.employee.DesignationTypeMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#DesignationType');
          var grid = this.view.down('#DesignationTypeGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#DesignationType");
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DesignationType').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.designatnTypeCode;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#DesignationType').getViewModel().setData(responseData.response.data);
     },
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.designatnTypeCode == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
