...
public class JobTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            jobtype.setJobDesc("5yU3O7no0zEi7LbYTRV7ecUp46KZAHtpl989cc61zpFYRA6LLq");
            jobtype.setJobHelp("V0v6nLP8H5IkclTe2dB7eWdvgpNbgipOd0fXZsSIVpzziee4CF");
            jobtype.setJobIcon("Zya");
    ...
    public void test2Update() {
        try {
            ...
            jobtype.setJobDesc("lYWpH9j1gSv1SAmnWniizjtepkY0vjltlMFCFrQUVne7bNkSBr");
            jobtype.setJobHelp("PRunICK4xVxF731V3TcASpHrDCCx3Xoh9AJDCdcJktbz4ZCd3v");
            jobtype.setJobIcon("e1v");
